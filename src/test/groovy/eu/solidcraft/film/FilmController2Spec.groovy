...
class FilmController2Spec extends IntegrationSpec implements FilmFacadeOperations {
    ...
    def "should get films"() {
        ...
        when: 'I go to /film'
            ResultActions getFilms = mockMvc.perform(get("/films2"))
    ...
    def "should get film"() {
        ...
        when: 'I go to /films'
            ResultActions getFilm = mockMvc.perform(get("/film2/$clingon.title"))
